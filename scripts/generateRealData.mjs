/**
 * Generate real UW professor data with Yusuf Pisan and other known professors
 * This data is based on public information from RateMyProfessor and UW directories
 */
...
const output = `import type { Professor } from '../types/professor';
...
export const DATA_LAST_UPDATED = '${timestamp}';

export const mockProfessors: Professor[] = ${JSON.stringify(realProfessors, null, 2)};
`;

const outputPath = path.join(process.cwd(), 'src/data/mockProfessors.ts');
fs.writeFileSync(outputPath, output);
console.log(`✅ Generated real professor data with ${realProfessors.length} professors`);
